export type { DeleteTasksIdMutationKey } from '../web/hooks/tasksHooks/useDeleteTasksId.ts'
...
export type {
  ...
  DeleteTasksId204Enum,
  DeleteTasksId204,
  DeleteTasksId404,
  DeleteTasksIdMutationResponse,
  DeleteTasksIdMutation,
} from './src/gen/types/DeleteTasksId.ts'
export type { GetTasksQueryParams, GetTasks200, GetTasksQueryResponse, GetTasksQuery } from './src/gen/types/GetTasks.ts'
export type {
  ...
  PatchTasksIdMutation,
} from './src/gen/types/PatchTasksId.ts'
export type { PostTasks201, PostTasksMutationRequest, PostTasksMutationResponse, PostTasksMutation } from './src/gen/types/PostTasks.ts'
export { deleteTasksIdMutationKey, deleteTasksId, useDeleteTasksId } from '../web/hooks/tasksHooks/useDeleteTasksId.ts'
